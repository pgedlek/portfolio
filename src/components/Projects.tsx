...
const projects = [
    {
        ...
        description: "A beatuful landing page app using React and TailwindCSS.",
        ...
        <section id="projects"
            ...
            <div className="container mx-auto max-w-5xl">
                <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">
                    {" "}
                    {t("projects.featured")} <span className="text-primary"> {t("projects.projects")} </span>
                </h2>
                            ...
                            <div className="p-6">
                                <div className="flex flex-wrap gap-2 mb-4">
                                    {project.tags.map((tag, tagKey) => (
                                        <span className="px-2 py-1 text-xs font-medium rounded-full bg-primary/30 text-secondary-foreground" key={tagKey}>
                                            {tag}
                                        </span>
                                    ))}
                                </div>
                ...
                <div className="text-center mt-12">
                    <a href="https://github.com/pgedlek"
                        target="_blank"
