...
// --- Utility Types ---
// Define a type for a React.Ref and its associated props for a given HTML element.
...
// Define a type that combines the `ToastRootProps` with the `variant` prop from cva.
type ToastProps = ToastRootProps & VariantProps<typeof toastVariants>;
